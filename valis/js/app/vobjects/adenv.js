...
define(['lodash', 'app/vobjects/vobject'], function (_, vobject) {
  var ADSREnvelope = function (_vobject$VObject) {
    ...
    function ADSREnvelope() {
      var attack = arguments.length <= 0 || arguments[0] === undefined ? 1 : arguments[0];
      var decay = arguments.length <= 1 || arguments[1] === undefined ? 1 : arguments[1];
      var sustain = arguments.length <= 2 || arguments[2] === undefined ? 0 : arguments[2];
      var release = arguments.length <= 3 || arguments[3] === undefined ? 1 : arguments[3];

      _classCallCheck(this, ADSREnvelope);

      var _this = _possibleConstructorReturn(this, Object.getPrototypeOf(ADSREnvelope).call(this, attack, decay));
